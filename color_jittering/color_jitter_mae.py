...
class MaskedAutoencoderCIFAR10(MaskedAutoencoderViT):
    def __init__(self, img_size=32, patch_size=2, in_chans=3, embed_dim=128, depth=12, num_heads=8, decoder_embed_dim=64, decoder_depth=6, decoder_num_heads=4, mlp_ratio=4, norm_layer=nn.LayerNorm, norm_pix_loss=False):
